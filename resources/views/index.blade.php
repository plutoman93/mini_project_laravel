                ...
                <div class="col-lg-6">
                    ...
                    <div class="trending-news-slider">
                        ...
                        <div class="item">
                            <div class="post-content">
                                <h2 class="post-title title-sm">
                                    <a href="single-post.html">Intels new smart glasses actually look good</a>
                                </h2>
                            </div>
                        </div>
                        <div class="item">
                        ...
                        <div class="news-style-one-slide">
                            <div class="item">
                                ...
                                <div class="post-block-wrapper clearfix mb-5 ">
                                    <div class="post-thumbnail">
                                        <a href="single-post.htm">
                                            <img class="img-fluid" src="asset/frontend/images/news/news-02.jpg"
                                                alt="post-thumbnail" />
                                        </a>
                                    </div>
                                    <div class="post-content">
                            ...
                            <div class="post-slide">
                                <div class="item">
                                    <div class="post-overlay-wrapper clearfix">
                                        <div class="post-thumbnail">
                                            <a href="single-post.html">
                                                <img class="img-fluid" src="asset/frontend/images/news/news-16.jpg"
                                                    alt="post-thumbnail" />
                                            </a>
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="post-overlay-wrapper clearfix mt-3">
                                        <div class="post-thumbnail">
                                            <a href="single-post.html">
                                                <img class="img-fluid" src="asset/frontend/images/news/news-18.jpg"
                                                    alt="post-thumbnail" />
                                            </a>
                                        </div>
                                        <div class="post-content">
                                ...
                                <div class="item ">
                                    <div class="post-overlay-wrapper clearfix">
                                        <div class="post-thumbnail">
                                            <a href="single-post.html">
                                                <img class="img-fluid" src="asset/frontend/images/news/news-17.jpg"
                                                    alt="post-thumbnail" />
                                            </a>
                                        </div>
                                    ...
                                    <div class="post-overlay-wrapper mt-3 clearfix">
                                        <div class="post-thumbnail">
                                            <a href="single-post.html">
                                                <img class="img-fluid" src="asset/frontend/images/news/news-19.jpg"
                                                    alt="post-thumbnail" />
                                            </a>
                                        </div>
                                        <div class="post-content">
...
================================================== -->
    ...
    <!-- Google Map -->
    <script src="asset/frontend/https://maps.googleapis.com/maps/api/js?key=AIzaSyCC72vZw-6tGqFyRhhg5CkF2fqfILn2Tsw">
    </script>
